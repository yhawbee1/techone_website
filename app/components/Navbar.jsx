...
const products = [
  ...
  { name: 'Offshore Outsourcing', description: 'Your customers’ data will be safe and secure', href: '#', icon: FingerPrintIcon },
  ...
  return (
    <header className="bg-white w-full">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <Link href="#" className="text-sm border font-semibold leading-6 text-gray-900 transition-all duration-200 border-violet-600 ">
        {/* <span class="ease absolute bottom-0 right-0 h-0 w-0 border-b-2 border-violet-600 transition-all duration-200 group-hover:w-full"></span> */}
          ...
          <Popover className="relative">
            <Popover.Button className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900 hover:bg-gradient-to-r from-black to-red-700 rounded hover:py-1 hover:px-2 hover:text-white">
              Our Services
